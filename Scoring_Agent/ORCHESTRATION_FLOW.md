...
└────────────────────────────────┬─────────────────────────────────────────────────────────────────────┘
 ...
 │  │  2. Call ai_scorer.ai_score_resume()                                                       │     │
 │  │     ┌─────────────────────────────────────────────────────────────────────────────────────┐   │   │
...
- `AgentState` enum: INIT → VALIDATING_INPUT → FETCHING_CONTEXT → SCORING → VERIFYING_OUTPUT → RAG_VALIDATION → COMPLETED/FAILED
...
### 5. **RAG Validation Layer (RAG_Validation_layer/)**
...
RAG Validation Layer
     ├─ Semantic Matching & Hallucination Check
     ├─ Ground Truth Score Calculation
     ├─ Rule-Based Evidence Generation
     └─ Pinecone Indexing for Retrieval
     ↓
